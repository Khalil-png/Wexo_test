...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] bg-[#0f0f0f]/90 backdrop-blur-xl border-t border-white/10 px-4 pb-6 pt-3 flex items-center justify-around lg:hidden animate-in slide-in-from-bottom-4 duration-500">
      {visibleTabs.map((tab) => (
        <button
          key={tab.id}
