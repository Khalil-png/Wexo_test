    ...
    <div className="max-w-4xl mx-auto py-12 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="mt-12 bg-[#1a1a1a] border border-white/5 rounded-2xl p-10 text-center">
        ...
        <p className="text-slate-500 text-sm font-medium mb-8 max-w-xl mx-auto">
          Pas besoin de retélécharger l'installateur à chaque fois. Quand une mise à jour est disponible, l'application se synchronise automatiquement avec <span className="text-white">wexo-steel.vercel.app</span> pour vous offrir les dernières nouveautés instantanément.
        </p>
