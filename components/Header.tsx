                    ...
                    <div className="flex items-center gap-3">
                      {notifications.some(n => !n.read) && (
                        <button 
                          ...
                          className="text-[9px] font-black text-white hover:opacity-80 transition-colors uppercase"
                        >
                          Tout lire
                        </button>
                      )}
                      {notifications.length > 0 && (
                        <button 
                          ...
                          className="text-[9px] font-black text-white/50 hover:text-white transition-colors uppercase"
                        >
                          Vider
                        </button>
                      )}
                        ...
                        {n.type === 'friend_request' ? (
                          ...
                          <div className="flex gap-4 items-start">
                            <div className="relative flex-shrink-0">
                              ...
                              <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#1a1a1a] rounded-full flex items-center justify-center border border-white/10 text-slate-300">
