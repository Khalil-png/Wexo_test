...
const Header: React.FC<HeaderProps> = ({ user, profile, onOpenAuth, onOpenLogout, onToggleSidebar, onTabChange, activeTab, onOpenCamera, isKeyboardActive }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 ${isMobileDevice() ? 'h-28 pt-8 items-end pb-4' : 'h-20 items-center'} bg-[#0f0f0f] border-b border-white/10 flex justify-between px-4 md:px-10 z-[100]`}>
